    ...
    <div
      ...
      style={{
        ...
        ...(isDashboard
          ? {
              backgroundImage: `
                radial-gradient(ellipse 600px 400px at 20% 20%, rgba(249,115,22,0.035) 0%, transparent 70%),
                radial-gradient(ellipse 500px 350px at 80% 60%, rgba(167,139,250,0.03) 0%, transparent 70%),
                radial-gradient(ellipse 400px 300px at 50% 80%, rgba(251,113,133,0.025) 0%, transparent 70%),
