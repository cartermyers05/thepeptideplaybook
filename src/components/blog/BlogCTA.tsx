      ...
      <div className="flex flex-col md:flex-row items-center gap-6">
        ...
        <div className="flex-1 text-center md:text-left">
          ...
          <p className="text-muted-foreground mb-4 md:mb-0">
            Get Peptide Playbook AI, the research-based platform covering BPC-157, semaglutide, TB-500, and more. Know what's FDA-approved, what's experimental, and what to ask your doctor.
          </p>
        </div>

        <Button asChild size="lg" className="btn-primary-clean flex-shrink-0">
          <Link to="/signup">
            Get Peptide Playbook AI
