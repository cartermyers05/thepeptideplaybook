...
const navItems = [
  ...
  { icon: ClipboardList, label: "Plan", path: "/dashboard/protocol" },
        ...
        {navItems.map((item) => {
          ...
          return (
            <NavLink
              ...
              className="flex flex-col items-center justify-center gap-1 px-3 py-2 min-w-[60px] text-gray-400 transition-colors"
